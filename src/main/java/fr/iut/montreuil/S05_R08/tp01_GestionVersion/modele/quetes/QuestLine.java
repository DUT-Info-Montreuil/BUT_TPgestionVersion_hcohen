...
public class QuestLine {
    ...
    public QuestLine(Joueur j){
        ...
        quetes.add(new TalkQuete("Chapitre 0 - Que veut le prof ?", "Q93130rs ?", 10, "Potion", 1, "spectre"));
        quetes.add(new TalkQuete("Chapitre 1 - C'est parti pour le TP", "lalalalalaalazlalalaal\n Serez vous de taille ?", 5, "Commit", 1, "vendeur"));
